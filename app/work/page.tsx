...
import { ArrowLeft, Plus, Sparkles, CheckCircle2, Clock, AlertCircle, Circle, Settings } from 'lucide-react'
import { workManagementApi } from '@/lib/api'
import type { WorkStatus, WorkPriority, WorkCategory } from '@/lib/types'
import { parseWorkWithOpenAI, getOpenAIKey } from '@/lib/openai'
              ...
              <div className="mb-6 p-5 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-red-900 mb-2">OpenAI API 키가 필요합니다</h3>
                    <p className="text-sm text-red-700 mb-3">
                      AI 업무 파싱 기능을 사용하려면 OpenAI API 키를 설정해야 합니다.
                    </p>
                    <Link
                      href="/settings"
                      className="inline-flex items-center space-x-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg transition-all"
                    >
